...
// 노트 수정 처리 (POST /notes/:id/edit) - 작성자만
router.post('/:id/edit', upload.single('file'), noteEditController.editNote);

// 노트 상세 조회 (GET /notes/:id)
router.get('/:id', noteController.getNoteById);

// 노트 삭제 처리 (POST /notes/:id/delete)
